...
#define PORTUDPCLIENT 49151
#define PORTUDPSERVER 49152
#define BUFSIZE 256
#define BACKLOG 10
...
int udp_method_client(int sockfd,struct socklen_t *len, struct sockaddr_in server,char *argv[]){
	char msg[BUFSIZE] = "Datagram SC1 in viaggio...";
...
int main(int argc, char *argv[]){
	...
	while (1){
		...
		printf("Il datagram ha fatto un ciclo completo in : %llu millisecondi\n",delta_us);
		sleep(1);
	}
